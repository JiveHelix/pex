...
public:
    ...
    Observer(Model &model)
        ...
        observed{}
    {
        this->terminus.Connect(this, &Observer::OnValue);
    }
...
TEST_CASE("Terminus aggregate observer receives message.", "[groups]")
{
    ...
    using TestObserver =
        Observer<Circle, CircleGroup::Model, CircleGroup::Control>; 
...
TEST_CASE("Terminus aggregate member observer receives message.", "[groups]")
{
    ...
    using TestObserver =
        Observer<Point, PointGroup::Model, PointGroup::Control>; 
